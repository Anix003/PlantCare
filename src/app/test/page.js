        ...
        {file && (
          <div className="flex items-center justify-center text-center mb-6">
            <button
              ...
              disabled={loading}
              className={`flex items-center justify-center mx-auto px-6 py-3 rounded-full text-white font-semibold transition duration-300 ${
                loading
            ...
            <div className="mt-6">
              {!result.detected ? (
                <div className="p-6 bg-green-100 border-l-4 border-green-500 text-green-800 rounded-xl text-center">
                  ...
                  <p>
                    Your plant appears to be healthy and shows no signs of
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4 text-center text-yellow-700">
                    Plant Health Concerns Detected
                  </h3>
