...
export default function SignUp() {
    ...
    try {
      ...
      if (result.userExists === false) {
        ...
        Swal.fire({
          ...
          text: "Your account has been created successfully. Please check your email to verify your account. Logging in...",
        ...
        const loginRes = await signIn("credentials", {
          redirect: false, // so we can control redirection
          email,
          password,
        });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 px-4 py-12 sm:px-6 lg:px-8">
      {/* Background Pattern */}
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/95 border-1 border-white/95 rounded-full backdrop-blur-sm text-gray-500 font-medium">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    } rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-gray-50 hover:bg-white`}
                    placeholder="John"
                  />
                </div>
                {errors.firstName && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-gray-50 hover:bg-white"
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-white/80">Get started in minutes</p>
            </div>
          </div>
          ...
          <div className="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-white/80">Your data is protected</p>
            </div>
          </div>
